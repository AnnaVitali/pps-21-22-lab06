...
trait NotTwoConsecutive[T] extends Parser[T]:
  private[this] var notTwoConsecutive: Boolean = false
  private[this] var currentElement: T
  abstract override def parse(t: T): Boolean =
    if t != currentElement then currentElement = t else notTwoConsecutive = true
    super.parse(t)
